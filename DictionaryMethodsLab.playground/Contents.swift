 ...
 */
var starWarsDriods = ["R2-D2", "C-3P0", "IG-88", "BB-8"]
 ...
 */
let droidToRemoveIndex = starWarsDriods.indexOf("IG-88")
if let droidToRemoveIndex = droidToRemoveIndex {
   starWarsDriods.removeAtIndex(droidToRemoveIndex)
}
 ...
 */
var starWarsCharacter = ["Heroes": starWarsHeroes,
                         "Villians": starWarsHeroes,
                         "Driods": starWarsDriods]
 ...
 */
starWarsCharacter.updateValue(starWarsGangsters, forKey: "Gangsters")
 ...
 */
for charactersType in starWarsCharacter.keys {
    print(charactersType)
}
 ...
 */
if starWarsCharacter.isEmpty {
    print("The dicitonary is empty!")
} else {
    print("There are \(starWarsCharacter.count) items in the dictionary")
}
...
starWarsCharacter.updateValue(starWarsJedi, forKey: "Jedi")
 ...
 */
if let bountyHunters = starWarsCharacter.removeValueForKey("Bounty Hunters") {
 ...
 */
 ...
 if var jedi = starWarsCharacter["Jedi"] {
 ...
 */
 ...
 if let heroes = starWarsCharacter["Heroes"] {
 for hero in heroes {
 print(hero)
 }
 }
